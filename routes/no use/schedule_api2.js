...
var scheduleModel = require('../model/schedule_model2');
var csv = require('csv');
var fs = require('fs');
			...
			scheduleModel.findByTrainAndTime("Y64110",today,function(err, doc){
		               if(err){callback(err, null);}
			                 ...
			                 if(typeof doc != undefined)
			                 {
							   ...
							   console.log("each schedule     ".green+doc.CIF_train_uid+"   "+ doc.time_schedule.length);
     ...
     .forEach(function(line){
		 ...
		 if(typeof data.JsonAssociationV1 != 'undefined')
         {
		   ...
		   try{
			 ...
			 scheduleModel.createNewSchedule({'CIF_train_uid':data.JsonScheduleV1.CIF_train_uid,'schedule_start_date':data.JsonScheduleV1.schedule_start_date,'schedule_end_date':data.JsonScheduleV1.schedule_end_date,'schedule_days_runs':runs,'time_schedule':a},function(){});			 
	     }
	 }
